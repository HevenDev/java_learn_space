...
class Calculator{
    int num; // here num acts like a intance variable, as it is the part of the instance
    public int add(int n1, int n2){ // n1 and n2 are the local variable as they are the part of your method
        return n1 + n2;
    }
}
